...
namespace TheCommissar
{
    public partial class cyberneticsForm : Form
    {
        ...
        private void addHomebrewAugments()
        {
            ...
            {
                string message = "Cant find the cyberHomebrew.json file! Have you moved it? Do you have read access to the directory the program is running from?";
            ...
            {
                string message = "There was an error loading cyberHomebrew.json! Did you make a mistake in your syntax?";
                string caption = "Error!";
                MessageBoxButtons button = MessageBoxButtons.OK;
                MessageBox.Show(message, caption, button, MessageBoxIcon.Error);
            }
